...
if(isset($_POST['submit'])){
  ...
  if (isset($_SESSION['full_name'])) {
      ...
      echo "<head><script>alert('Session data not available. Please log in again.');</script></head></html>";
  }
}
...
<body class="page-body page-fade" onload="collapseSidebar()">
    ...
    <div class="page-container sidebar-collapsed" id="navbarcollapse">    
        ...
        <div class="main-content">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-4 clearfix hidden-xs">
                    <ul class="list-inline links-list pull-right">
                        <li>Welcome <?php echo isset($_SESSION['full_name']) ? $_SESSION['full_name'] : ''; ?> </li>                     
                        <li>
                            <a href="logout.php">
            ...
            <?php $user_id_auth = isset($_SESSION['user_data']) ? $_SESSION['user_data'] : ''; ?>
                            ...
                            <tr>
                                <td height="35">
                                    <table width="100%" border="0" align="center">
                                        <tr>
                                            <td height="35">ID:</td>
                                            <td height="35"><input type="text" name="login_id" value="<?php echo isset($_SESSION['user_data']) ? $_SESSION['user_data'] : ''; ?>" class="form-control" required/></td>
                                        </tr>
                                        <tr>
                                            <td height="35">FULL NAME:</td>
                                            <td height="35"><input class="form-control" type="text" name="full_name" value="<?php echo isset($_SESSION['username']) ? $_SESSION['username'] : ''; ?>" maxlength="25" required></td>
                                        </tr>
                                        <tr>
                                            <td height="35">PASSWORD</td>
                                            <td height="35"><span class="form-control">*********</span> <a href="change_pwd.php" class="a1-btn a1-orange">Change password</a> <span class="help-block">*For security reasons hidden</span></td>
                                        </tr>
                                        <tr>
                                            <td height="35">&nbsp;</td>
                                            <td height="35">

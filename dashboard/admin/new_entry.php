                    ...
                    <form id="form1" name="form1" method="post" class="a1-container" action="new_submit.php">
                        <table width="100%" border="0" align="center">
                            <tr>
                                ...
                                <td height="35">
                                    <input type="text" id="boxx" name="m_id" required placeholder="Enter Membership ID" />
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td height="35"><input type="text" name="state" id="boxx" required/></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td height="35"><input type="number" name="mobile" id="boxx" maxlength="10" required/></td>
                            </tr>
                            <tr>
                                <td height="35">EMAIL ID:</td>
                                <td height="35"><input type="email" name="email" id="boxx" required/></td>
                            </tr>
                            <tr>
                                <td height="35">JOINING DATE:</td>
                                <td height="35"><input type="date" name="jdate" id="boxx" required/></td>
                            </tr>
                            <tr>
